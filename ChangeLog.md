...
**Expected Production Release Date: January 2, 2023**
## Change #1
...
3. `<indexTerms>` container element with an `<item>` for each item. In each `<item>` container, `<name>` element will be added for each index term.
