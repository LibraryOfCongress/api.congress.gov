    ...
    - `<item>` 
      - Container for the member’s service in an individual Congress. The `<item>` element may contain the following children: 
        ...
        - `<congress>` (e.g., 94)
          ...
          - View the [field values list of Congresses](https://www.congress.gov/help/field-values/congresses) on Congress.gov. Read more about Congresses on Congress.gov.
